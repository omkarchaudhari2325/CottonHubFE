      ...
      <div className="form-container shadow-xl rounded-lg w-7/12 p-5 ">
        ...
        <div className="details">
          ...
          <input
            ...
            type="password"
            className="mt-5 w-full h-10 border p-2 rounded-lg border-gray-600 outline-none"
            name="password"
            onChange={(e) => {
          ...
          <button
            ...
            className="mt-5 bg-light-blue-600 w-32 h-10 rounded-lg text-white hover:bg-light-blue-500 cursor-pointer"
          >
            Verify
          </button>
        </div>
        ...
        {isPasswordValid && (
          <div className="details mt-6">
            ...
            <button
              ...
              className="mt-5 bg-black w-40 h-10 rounded-lg text-white"
            >
              Change Password
            </button>
          </div>
